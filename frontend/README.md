# ManuscriptAI - Frontend

This is the Next.js client web application for **ManuscriptAI**. It provides a premium, responsive dashboard for uploading manuscripts and converting them to compliant journal formats (like IEEE).
...
*Note: During build processes and prerendering, if these environment variables are absent, the application automatically falls back to dummy configurations to avoid build-time errors.*
